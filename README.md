...
* **PREVIEW**: The latest pre-release is [r1.2](https://github.com/hdamker/TestRepo-New/releases/tag/r1.2) (release candidate), with the following API versions:
  * **quality-on-demand 0.1.0-rc.2**
