...
* **NEW**: The latest public release is [r2.2](https://github.com/hdamker/TestRepo-New/releases/tag/r2.2), with the following API versions:
...
* Pre-release: [r3.1](https://github.com/hdamker/TestRepo-New/releases/tag/r3.1) (release candidate)
  * **quality-on-demand 1.1.0-rc.2**
  [[YAML]](https://github.com/hdamker/TestRepo-New/blob/r3.1/code/API_definitions/quality-on-demand.yaml)  [[ReDoc]](https://redocly.github.io/redoc/?url=https://raw.githubusercontent.com/hdamker/TestRepo-New/r3.1/code/API_definitions/quality-on-demand.yaml&nocors)  [[Swagger]](https://camaraproject.github.io/swagger-ui/?url=https://raw.githubusercontent.com/hdamker/TestRepo-New/r3.1/code/API_definitions/quality-on-demand.yaml)
